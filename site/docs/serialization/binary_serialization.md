...
[Named lambdas](../expressions/lambda_expressions.md#named-lambdas) use the same anchor and reference naming convention, but their anchors form a separate namespace from extension function anchors.
