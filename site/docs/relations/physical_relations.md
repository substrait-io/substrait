...
| Keys                | One or more comparison keys to join on. Each key specifies the field to compare from the left input, the field to compare from the right input, and how to compare them.                                                | Required                                           |
