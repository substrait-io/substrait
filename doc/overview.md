...
| -------- | ------ | --------------------------------------------------- | ------------------------------------------------------------ |
| 1        | sketch | [Simple Logical Types](types_logical_simple.md)     | A way to describe the set of basic types that will be operated on within a plan. Only includes simple types such as integers and doubles (nothing configurable or compound). |
|          | sketch | [Compound Logical Types](types_logical_compound.md) | Expression of types that go beyond simple scalar values. Key concepts here include: configurable types such as fixed length and numeric types as well as compound types such as structs, maps, lists, etc. |
|          | sketch | [Physical Types](types_physical.md)                 | Physical extensions to logical types.                        |
| 2        | sketch | [Field References](field_references.md)             | Expressions to identify which portions of a record should be |
| 3        | sketch | [Function Signatures](function_signatures.md)       | Description of how functions are specified. Concepts include arguments, variadic functions, output type derivation, etc. |
|          | sketch | [Common Functions](../functions/functions.yaml)     | A list of well-known canonical functions.                    |
